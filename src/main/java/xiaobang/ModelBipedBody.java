...
public class ModelBipedBody {
    ...
    public static void init(JinRyuu.JRMCore.entity.ModelBipedBody body, float par1) {
        try {
            ...
            bodyRenderer.setRotationPointY2(12.0F);
            ...
            body.bipedHeadwear = convertBends(body, PartRenderer.class, body.bipedHeadwear);
